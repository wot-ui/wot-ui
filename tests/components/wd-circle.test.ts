...
import { type StrokeLinecapType } from '@/uni_modules/wot-ui/components/wd-circle/types'
import WdCircle from '@/uni_modules/wot-ui/components/wd-circle/wd-circle.vue'
describe('WdCircle', () => {
  beforeEach(() => {
    vi.useFakeTimers()
  })
