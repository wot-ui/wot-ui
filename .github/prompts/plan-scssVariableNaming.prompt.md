...
| 层级 | 名称 | 说明 | 示例 |
|------|------|------|------|
| L1 | 基础令牌 (Base Tokens) | 原始色值、数值，无语义 | `--wot-blue-6`, `--wot-n16` |
...
$cell-title-font-size: var(--wot-cell-title-font-size, $n16) !default;
...
// ✅ 正确 - 无元素，按尺寸分组
$button-height-small: var(--wot-button-height-small, $n32) !default;
$button-font-size-small: var(--wot-button-font-size-small, $n14) !default;
...
// 3. 尺寸变量 - 按尺寸分组
// 3.1 Mini
$button-font-size-mini: var(--wot-button-font-size-mini, $n12) !default;
$button-height-mini: var(--wot-button-height-mini, $n24) !default;
