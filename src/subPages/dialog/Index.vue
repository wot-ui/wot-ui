  ...
  <view class="page-dialog">
    <page-wraper>
      ...
      <demo-block title="按钮配置">
        ...
        <wd-button type="primary" plain block custom-style="margin-bottom: 12px" @click="multipleActions">多个按钮（Actions）</wd-button>
      ...
      <!-- 开放能力 -->
      <demo-block title="开放能力（OpenType）">
