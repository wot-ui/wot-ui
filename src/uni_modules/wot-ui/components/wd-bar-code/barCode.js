        ...
        function CODE128AUTO(data, options) {
          ...
          if (/^[\x00-\x7F\xC8-\xD3]+$/.test(data)) {
            var _this = _possibleConstructorReturn(
              this,
              (CODE128AUTO.__proto__ || Object.getPrototypeOf(CODE128AUTO)).call(this, (0, _auto2.default)(data), options)
            )
          } else {
              ...
              value: function encode() {
                ...
                return {
                  ...
                  data:
                    ...
                    encoded +
                    // Add the checksum
                    CODE93.getEncoding(csumC) +
                    CODE93.getEncoding(csumK) +
                    // Add the stop bits
                    CODE93.getEncoding('\xff') +
        ...
        _createClass(CanvasRenderer, [
          {
            ...
            value: function render() {
              ...
              if (!this.canvas.getContext && !this.canvas.draw) {
          ...
          },
          {
            ...
            value: function prepareCanvas() {
              ...
              var ctx = this.canvas.getContext ? this.canvas.getContext('2d') : this.canvas
              ...
              if (this.options.background) {
                if (ctx.setFillStyle) ctx.setFillStyle(this.options.background)
                else ctx.fillStyle = this.options.background
          ...
          },
          {
            ...
            value: function drawCanvasBarcode(options, encoding) {
              ...
              if (ctx.setFillStyle) ctx.setFillStyle(options.lineColor)
              else ctx.fillStyle = options.lineColor
          ...
          },
          {
            ...
            value: function drawCanvasText(options, encoding) {
              ...
              if (options.displayValue) {
                ...
                ctx.font = font
                if (ctx.setFontSize) ctx.setFontSize(options.fontSize)
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var SVGRenderer = (function () {
        function SVGRenderer(svg, encodings, options) {
          ...
          this.encodings = encodings
          this.options = options
          this.document = options.xmlDocument || (typeof document !== 'undefined' ? document : undefined)
        }
