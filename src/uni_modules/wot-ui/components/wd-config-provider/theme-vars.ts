...
export type baseThemeVars = {
  baseBlack?: string // 基础黑色
  baseTransparent?: string // 基础透明色
  baseWhite?: string // 基础白色
  blue1?: string // 蓝色色阶 1
  blue10?: string // 蓝色色阶 10
  blue2?: string // 蓝色色阶 2
  blue3?: string // 蓝色色阶 3
  blue4?: string // 蓝色色阶 4
  blue5?: string // 蓝色色阶 5
  ...
  blue8?: string // 蓝色色阶 8
  blue9?: string // 蓝色色阶 9
  blueOpac?: string // 蓝色透明色
  borderExtraStrong?: string // 超强边框色
  borderLight?: string // 轻量边框色
  borderMain?: string // 默认边框色
  borderStrong?: string // 强边框色
  borderWhite?: string // 白色边框色
  borderZero?: string // 零边框色
  classifyapplicationCyanBackground?: string // 分类应用青色背景色
  classifyapplicationCyanBorder?: string // 分类应用青色边框色
  classifyapplicationCyanContent?: string // 分类应用青色内容色
  classifyapplicationGrapeBackground?: string // 分类应用靛色背景色
  classifyapplicationGrapeBorder?: string // 分类应用靛色边框色
  classifyapplicationGrapeContent?: string // 分类应用靛色内容色
  classifyapplicationPinkBackground?: string // 分类应用粉色背景色
  classifyapplicationPinkBorder?: string // 分类应用粉色边框色
  classifyapplicationPinkContent?: string // 分类应用粉色内容色
  classifyapplicationPurpleBackground?: string // 分类应用紫色背景色
  classifyapplicationPurpleBorder?: string // 分类应用紫色边框色
  classifyapplicationPurpleContent?: string // 分类应用紫色内容色
  classifyapplicationYellowBackground?: string // 分类应用黄色背景色
  classifyapplicationYellowBorder?: string // 分类应用黄色边框色
  classifyapplicationYellowContent?: string // 分类应用黄色内容色
  coolgrey1?: string // 冷灰色色阶 1
  coolgrey10?: string // 冷灰色色阶 10
  coolgrey2?: string // 冷灰色色阶 2
  coolgrey3?: string // 冷灰色色阶 3
  coolgrey4?: string // 冷灰色色阶 4
  coolgrey5?: string // 冷灰色色阶 5
  coolgrey6?: string // 冷灰色色阶 6
  coolgrey7?: string // 冷灰色色阶 7
  coolgrey8?: string // 冷灰色色阶 8
  coolgrey9?: string // 冷灰色色阶 9
  cyan1?: string // 青色色阶 1
  cyan10?: string // 青色色阶 10
  cyan2?: string // 青色色阶 2
  cyan3?: string // 青色色阶 3
  cyan4?: string // 青色色阶 4
  cyan5?: string // 青色色阶 5
  ...
  cyan8?: string // 青色色阶 8
  cyan9?: string // 青色色阶 9
  cyanOpac?: string // 青色透明色
  dangerClicked?: string // 危险色点击态
  dangerDisabled?: string // 危险色禁用态
  dangerHover?: string // 危险色悬浮态
  dangerMain?: string // 危险色默认
  dangerParticular?: string // 危险色强调
  dangerSurface?: string // 危险色表层
  dividerLight?: string // 轻量分割线颜色
  dividerMain?: string // 默认分割线颜色
  dividerStrong?: string // 强分割线颜色
  dividerWhite?: string // 白色分割线颜色
  feedbackAccent?: string // 反馈强调颜色
  feedbackActive?: string // 反馈激活态颜色
  feedbackHover?: string // 反馈悬浮态颜色
  filledBottom?: string // 底层填充色
  filledContent?: string // 内容填充色
  filledExtraStrong?: string // 超强填充色
  filledOppo?: string // 反向填充色
  filledStrong?: string // 强填充色
  filledZero?: string // 零填充色
  fontWeightBold?: string // 加粗字重
  fontWeightLight?: string // 轻量字重
  fontWeightMedium?: string // medium字重
  fontWeightRegular?: string // regular字重
  fontWeightSemibold?: string // semibold字重
  fontWeightThin?: string // thin字重
  fontWeightUltraLight?: string // ultra-light字重
  grape1?: string // 靛色色阶 1
  grape10?: string // 靛色色阶 10
  grape2?: string // 靛色色阶 2
  grape3?: string // 靛色色阶 3
  grape4?: string // 靛色色阶 4
  grape5?: string // 靛色色阶 5
  grape6?: string // 靛色色阶 6
  grape7?: string // 靛色色阶 7
  grape8?: string // 靛色色阶 8
  grape9?: string // 靛色色阶 9
  grapeOpac?: string // 靛色透明色
  green1?: string // 绿色色阶 1
  green10?: string // 绿色色阶 10
  green2?: string // 绿色色阶 2
  green3?: string // 绿色色阶 3
  green4?: string // 绿色色阶 4
  green5?: string // 绿色色阶 5
  green6?: string // 绿色色阶 6
  green7?: string // 绿色色阶 7
  green8?: string // 绿色色阶 8
  green9?: string // 绿色色阶 9
  greenOpac?: string // 绿色透明色
  iconAuxiliary?: string // 辅助图标颜色
  iconDisabled?: string // 禁用图标颜色
  iconMain?: string // 主要图标颜色
  iconPlaceholder?: string // 占位图标颜色
  iconSecondary?: string // 次要图标颜色
  iconWhite?: string // 白色图标颜色
  lightblue1?: string // 亮蓝色色阶 1
  lightblue10?: string // 亮蓝色色阶 10
  lightblue2?: string // 亮蓝色色阶 2
  lightblue3?: string // 亮蓝色色阶 3
  lightblue4?: string // 亮蓝色色阶 4
  lightblue5?: string // 亮蓝色色阶 5
  lightblue6?: string // 亮蓝色色阶 6
  lightblue7?: string // 亮蓝色色阶 7
  lightblue8?: string // 亮蓝色色阶 8
  lightblue9?: string // 亮蓝色色阶 9
  lightblueOpac?: string // 亮蓝色透明色
  n0?: string // 基础尺寸 0px
  n05?: string // 基础尺寸 0.5px
  n1?: string // 基础尺寸 1px
  n10?: string // 基础尺寸 10px
  n11?: string // 基础尺寸 11px
  n12?: string // 基础尺寸 12px
  n14?: string // 基础尺寸 14px
  n15?: string // 基础尺寸 15px
  n16?: string // 基础尺寸 16px
  n17?: string // 基础尺寸 17px
  n18?: string // 基础尺寸 18px
  n2?: string // 基础尺寸 2px
  n20?: string // 基础尺寸 20px
  n22?: string // 基础尺寸 22px
  n24?: string // 基础尺寸 24px
  n248?: string // 基础尺寸 248px
  n26?: string // 基础尺寸 26px
  n28?: string // 基础尺寸 28px
  n3?: string // 基础尺寸 3px
  n32?: string // 基础尺寸 32px
  n34?: string // 基础尺寸 34px
  n36?: string // 基础尺寸 36px
  n375?: string // 基础尺寸 375px
  n4?: string // 基础尺寸 4px
  n40?: string // 基础尺寸 40px
  n44?: string // 基础尺寸 44px
  n48?: string // 基础尺寸 48px
  n5?: string // 基础尺寸 5px
  n50?: string // 基础尺寸 50px
  n52?: string // 基础尺寸 52px
  n56?: string // 基础尺寸 56px
  n6?: string // 基础尺寸 6px
  n60?: string // 基础尺寸 60px
  n64?: string // 基础尺寸 64px
  n8?: string // 基础尺寸 8px
  n88?: string // 基础尺寸 88px
  n9?: string // 基础尺寸 9px
  n98?: string // 基础尺寸 98px
  neutralgrey1?: string // 中性灰色色阶 1
  neutralgrey10?: string // 中性灰色色阶 10
  neutralgrey2?: string // 中性灰色色阶 2
  neutralgrey3?: string // 中性灰色色阶 3
  neutralgrey4?: string // 中性灰色色阶 4
  neutralgrey5?: string // 中性灰色色阶 5
  neutralgrey6?: string // 中性灰色色阶 6
  neutralgrey7?: string // 中性灰色色阶 7
  neutralgrey8?: string // 中性灰色色阶 8
  neutralgrey9?: string // 中性灰色色阶 9
  nFull?: string // 全圆角尺寸
  opac1_02?: string // 黑色遮罩 02%
  opac10_85?: string // 黑色遮罩 85%
  opac2_04?: string // 黑色遮罩 04%
  opac3_08?: string // 黑色遮罩 08%
  opac4_15?: string // 黑色遮罩 15%
  opac5_20?: string // 黑色遮罩 20%
  opac6_30?: string // 黑色遮罩 30%
  opac7_45?: string // 黑色遮罩 45%
  opac7_55?: string // 黑色遮罩 55%
  opac8_65?: string // 黑色遮罩 65%
  opac9_75?: string // 黑色遮罩 75%
  opacfilledLightCover?: string // 轻量透明填充遮罩
  opacfilledMainCover?: string // 默认透明填充遮罩
  opacfilledTooltipToastCover?: string // tooltip-toast透明填充遮罩
  opacityBackdrop?: string // backdrop透明度
  opacityDimmer?: string // dimmer透明度
  opacityDisabled?: string // 禁用态透明度
  opacityMain?: string // 默认透明度
  opacityOverlay?: string // overlay透明度
  opacwhite1_02?: string // 白色遮罩 02%
  opacwhite10_85?: string // 白色遮罩 85%
  opacwhite2_04?: string // 白色遮罩 04%
  opacwhite3_08?: string // 白色遮罩 08%
  opacwhite4_15?: string // 白色遮罩 15%
  opacwhite5_20?: string // 白色遮罩 20%
  opacwhite6_30?: string // 白色遮罩 30%
  opacwhite7_45?: string // 白色遮罩 45%
  opacwhite7_55?: string // 白色遮罩 55%
  opacwhite8_65?: string // 白色遮罩 65%
  opacwhite9_75?: string // 白色遮罩 75%
  orange1?: string // 橙色色阶 1
  orange10?: string // 橙色色阶 10
  orange2?: string // 橙色色阶 2
  orange3?: string // 橙色色阶 3
  orange4?: string // 橙色色阶 4
  orange5?: string // 橙色色阶 5
  orange6?: string // 橙色色阶 6
  orange7?: string // 橙色色阶 7
  orange8?: string // 橙色色阶 8
  orange9?: string // 橙色色阶 9
  orangeOpac?: string // 橙色透明色
  paddingExtraLoose?: string // 较宽松内边距
  paddingExtraSpacious?: string // 较舒展内边距
  paddingExtraTight?: string // 较紧凑内边距
  paddingLoose?: string // 宽松内边距
  paddingMain?: string // 默认内边距
  paddingSpacious?: string // 舒展内边距
  paddingSuperLoose?: string // 超宽松内边距
  paddingSuperSpacious?: string // 超舒展内边距
  paddingSuperTight?: string // 超紧凑内边距
  paddingTight?: string // 紧凑内边距
  paddingUltraLoose?: string // 极宽松内边距
  paddingUltraSpacious?: string // 极舒展内边距
  paddingUltraTight?: string // 极紧凑内边距
  paddingZero?: string // 零内边距
  pink1?: string // 粉色色阶 1
  pink10?: string // 粉色色阶 10
  pink2?: string // 粉色色阶 2
  pink3?: string // 粉色色阶 3
  pink4?: string // 粉色色阶 4
  pink5?: string // 粉色色阶 5
  ...
  pink8?: string // 粉色色阶 8
  pink9?: string // 粉色色阶 9
  pinkOpac?: string // 粉色透明色
  primary1?: string // 主色色阶 1
  primary10?: string // 主色色阶 10
  primary2?: string // 主色色阶 2
  primary3?: string // 主色色阶 3
  primary4?: string // 主色色阶 4
  primary5?: string // 主色色阶 5
  primary6?: string // 主色色阶 6
  primary7?: string // 主色色阶 7
  primary8?: string // 主色色阶 8
  primary9?: string // 主色色阶 9
  purple1?: string // 紫色色阶 1
  purple10?: string // 紫色色阶 10
  purple2?: string // 紫色色阶 2
  purple3?: string // 紫色色阶 3
  purple4?: string // 紫色色阶 4
  purple5?: string // 紫色色阶 5
  purple6?: string // 紫色色阶 6
  purple7?: string // 紫色色阶 7
  purple8?: string // 紫色色阶 8
  purple9?: string // 紫色色阶 9
  purpleOpac?: string // 紫色透明色
  radiusExtraLarge?: string // 特大号圆角
  radiusFull?: string // 全量圆角
  radiusLarge?: string // 大号圆角
  radiusMain?: string // 默认圆角
  radiusSmall?: string // 小号圆角
  radiusSuperLarge?: string // 超大号圆角
  radiusUltraLarge?: string // 极大号圆角
  radiusZero?: string // 零圆角
  red1?: string // 红色色阶 1
  red10?: string // 红色色阶 10
  red2?: string // 红色色阶 2
  red3?: string // 红色色阶 3
  red4?: string // 红色色阶 4
  red5?: string // 红色色阶 5
  ...
  red8?: string // 红色色阶 8
  red9?: string // 红色色阶 9
  redOpac?: string // 红色透明色
  spacingExtraLoose?: string // 较宽松间距
  spacingExtraSpacious?: string // 较舒展间距
  spacingExtraTight?: string // 较紧凑间距
  spacingLoose?: string // 宽松间距
  spacingMain?: string // 默认间距
  spacingSpacious?: string // 舒展间距
  spacingSuperLoose?: string // 超宽松间距
  spacingSuperSpacious?: string // 超舒展间距
  spacingSuperTight?: string // 超紧凑间距
  spacingTight?: string // 紧凑间距
  spacingUltraLoose?: string // 极宽松间距
  spacingUltraSpacious?: string // 极舒展间距
  spacingUltraTight?: string // 极紧凑间距
  spacingZero?: string // 零间距
  strokeBold?: string // 加粗边框线宽
  strokeLight?: string // 轻量边框线宽
  strokeMain?: string // 默认边框线宽
  strokeZero?: string // 零边框线宽
  successClicked?: string // 成功色点击态
  successDisabled?: string // 成功色禁用态
  successHover?: string // 成功色悬浮态
  successMain?: string // 成功色默认
  successParticular?: string // 成功色强调
  successSurface?: string // 成功色表层
  textAuxiliary?: string // 辅助文字颜色
  textDisabled?: string // 禁用文字颜色
  textMain?: string // 主要文字颜色
  textPlaceholder?: string // 占位文字颜色
  textSecondary?: string // 次要文字颜色
  textWhite?: string // 白色文字颜色
  typographyBodyFontFamily?: string // 正文文本字体族
  typographyBodyFontWeightExtraStrong?: string // 正文文本超强字重
  typographyBodyFontWeightMain?: string // 正文文本默认字重
  typographyBodyFontWeightStrong?: string // 正文文本强字重
  typographyBodyLineHeightSizeExtraLarge?: string // 正文文本特大号行高
  typographyBodyLineHeightSizeLarge?: string // 正文文本大号行高
  typographyBodyLineHeightSizeMain?: string // 正文文本默认行高
  typographyBodyLineHeightSizeSuperLarge?: string // 正文文本超大号行高
  typographyBodyLineHeightSizeUltraLarge?: string // 正文文本极大号行高
  typographyBodySizeExtraLarge?: string // 正文文本特大号字号
  typographyBodySizeLarge?: string // 正文文本大号字号
  typographyBodySizeMain?: string // 正文文本默认字号
  typographyBodySizeSuperLarge?: string // 正文文本超大号字号
  typographyBodySizeUltraLarge?: string // 正文文本极大号字号
  typographyLabelFontFamily?: string // 标签文本字体族
  typographyLabelFontWeightMain?: string // 标签文本默认字重
  typographyLabelFontWeightStrong?: string // 标签文本强字重
  typographyLabelLineHeightSizeExtraSmall?: string // 标签文本特小号行高
  typographyLabelLineHeightSizeLarge?: string // 标签文本大号行高
  typographyLabelLineHeightSizeMain?: string // 标签文本默认行高
  typographyLabelLineHeightSizeSmall?: string // 标签文本小号行高
  typographyLabelLineHeightSizeSuperSmall?: string // 标签文本超小号行高
  typographyLabelSizeExtraSmall?: string // 标签文本特小号字号
  typographyLabelSizeLarge?: string // 标签文本大号字号
  typographyLabelSizeMain?: string // 标签文本默认字号
  typographyLabelSizeSmall?: string // 标签文本小号字号
  typographyLabelSizeSuperSmall?: string // 标签文本超小号字号
  typographyTitleFontFamily?: string // 标题文本字体族
  typographyTitleFontWeightLight?: string // 标题文本轻量字重
  typographyTitleFontWeightMain?: string // 标题文本默认字重
  typographyTitleFontWeightStrong?: string // 标题文本强字重
  typographyTitleLineHeightSizeExtraLarge?: string // 标题文本特大号行高
  typographyTitleLineHeightSizeLarge?: string // 标题文本大号行高
  typographyTitleLineHeightSizeMain?: string // 标题文本默认行高
  typographyTitleSizeExtraLarge?: string // 标题文本特大号字号
  typographyTitleSizeLarge?: string // 标题文本大号字号
  typographyTitleSizeMain?: string // 标题文本默认字号
  volcano1?: string // 橘红色色阶 1
  volcano10?: string // 橘红色色阶 10
  volcano2?: string // 橘红色色阶 2
  volcano3?: string // 橘红色色阶 3
  volcano4?: string // 橘红色色阶 4
  volcano5?: string // 橘红色色阶 5
  volcano6?: string // 橘红色色阶 6
  volcano7?: string // 橘红色色阶 7
  volcano8?: string // 橘红色色阶 8
  volcano9?: string // 橘红色色阶 9
  volcanoOpac?: string // 橘红色透明色
  warmgrey1?: string // 暖灰色色阶 1
  warmgrey10?: string // 暖灰色色阶 10
  warmgrey2?: string // 暖灰色色阶 2
  warmgrey3?: string // 暖灰色色阶 3
  warmgrey4?: string // 暖灰色色阶 4
  warmgrey5?: string // 暖灰色色阶 5
  warmgrey6?: string // 暖灰色色阶 6
  warmgrey7?: string // 暖灰色色阶 7
  warmgrey8?: string // 暖灰色色阶 8
  warmgrey9?: string // 暖灰色色阶 9
  warningClicked?: string // 警告色点击态
  warningDisabled?: string // 警告色禁用态
  warningHover?: string // 警告色悬浮态
  warningMain?: string // 警告色默认
  warningParticular?: string // 警告色强调
  warningSurface?: string // 警告色表层
  yellow1?: string // 黄色色阶 1
  yellow10?: string // 黄色色阶 10
  yellow2?: string // 黄色色阶 2
  yellow3?: string // 黄色色阶 3
  yellow4?: string // 黄色色阶 4
  yellow5?: string // 黄色色阶 5
  yellow6?: string // 黄色色阶 6
  yellow7?: string // 黄色色阶 7
  yellow8?: string // 黄色色阶 8
  yellow9?: string // 黄色色阶 9
  yellowOpac?: string // 黄色透明色
}
...
export type indexAnchorThemeVars = {
  indexAnchorBg?: string // 索引锚点背景色
  indexAnchorColor?: string // 索引锚点文字颜色
  indexAnchorFontSize?: string // 索引锚点文字字号
  indexAnchorPadding?: string // 索引锚点内边距
  indexAnchorZIndex?: string // 索引锚点吸顶层级
}

export type indexBarThemeVars = {
  indexBarCurrentIndexBg?: string // 当前索引提示背景色
  indexBarCurrentIndexColor?: string // 当前索引提示文字颜色
  indexBarCurrentIndexFontSize?: string // 当前索引提示文字字号
  indexBarCurrentIndexSize?: string // 当前索引提示尺寸
  indexBarCurrentIndexZIndex?: string // 当前索引提示层级
  indexBarIndexBgActive?: string // 激活索引项背景色
  indexBarIndexBorderRadius?: string // 索引项圆角
  indexBarIndexColor?: string // 索引项文字颜色
  indexBarIndexColorActive?: string // 激活索引项文字颜色
  indexBarIndexFontSize?: string // 索引项文字字号
  indexBarIndexFontWeight?: string // 索引项字重
  indexBarIndexHeight?: string // 索引项高度
  indexBarIndexWidth?: string // 索引项宽度
  indexBarSidebarRight?: string // 索引侧边栏右侧偏移
}
...
export type sliderThemeVars = {
  sliderBarBg?: string // 轨道背景色
  sliderBarHeight?: string // 轨道高度
  sliderBarHeightCapsule?: string // 胶囊轨道高度
  sliderBarHeightVertical?: string // 垂直轨道高度
  sliderBarRadius?: string // 轨道圆角
  sliderCapsuleTrackInset?: string // 胶囊轨道内缩距离
  sliderDotBg?: string // 滑块背景色
  sliderDotPopoverArrowHeight?: string // 气泡提示箭头高度
  sliderDotPopoverArrowWidth?: string // 气泡提示箭头宽度
  sliderDotPopoverBg?: string // 气泡提示背景色
  sliderDotPopoverColor?: string // 气泡提示文字颜色
  sliderDotPopoverDurationEnter?: string // 气泡提示入场动画时长
  sliderDotPopoverDurationExit?: string // 气泡提示离场动画时长
  sliderDotPopoverEasingEnter?: string // 气泡提示入场动画缓动
  sliderDotPopoverEasingExit?: string // 气泡提示离场动画缓动
  sliderDotPopoverFontSize?: string // 气泡提示文字字号
  sliderDotPopoverGap?: string // 气泡提示与滑块间距
  sliderDotPopoverLineHeight?: string // 气泡提示行高
  sliderDotPopoverPadding?: string // 气泡提示内边距
  sliderDotPopoverRadius?: string // 气泡提示圆角
  sliderDotShadow?: string // 滑块阴影
  sliderDotSize?: string // 滑块尺寸
  sliderExtremeSpacing?: string // 极值文字与轨道间距
  sliderLineBg?: string // 进度条背景色
  sliderLineHeight?: string // 进度条高度
  sliderLineHeightCapsule?: string // 胶囊进度条高度
  sliderMarksDescCapsuleSpacing?: string // 胶囊标记描述间距
  sliderMarksDescSpacing?: string // 标记描述间距
  sliderMarksExtraCapsulePadding?: string // 胶囊标记额外内边距
  sliderMarksExtraPadding?: string // 标记额外内边距
  sliderOpacityDisabled?: string // 禁用态透明度
  sliderScaleBg?: string // 刻度背景色
  sliderScaleBgActive?: string // 激活刻度背景色
  sliderScaleBorderRadius?: string // 刻度圆角
  sliderScaleCapsuleBg?: string // 胶囊刻度背景色
  sliderScaleCapsuleBorderRadius?: string // 胶囊刻度圆角
  sliderScaleCapsuleWidth?: string // 胶囊刻度宽度
  sliderScaleDescColor?: string // 刻度描述文字颜色
  sliderScaleDescFontSize?: string // 刻度描述文字字号
  sliderScaleDescLineHeight?: string // 刻度描述行高
  sliderScaleDescSpacing?: string // 刻度描述间距
  sliderScaleSize?: string // 刻度尺寸
  sliderValueColor?: string // 极值文字颜色
  sliderValueFontSize?: string // 极值文字字号
}
