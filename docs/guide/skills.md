...
| `migrate-v1-to-v2` | 将 Wot UI v1 项目迁移到 v2。 | 扫描旧用法、迁移不兼容 API、处理表单与主题变更、按人工审核结果迁移内置图标。 | [skills/migrate-v1-to-v2/SKILL.md](https://github.com/wot-ui/open-wot/tree/main/skills/migrate-v1-to-v2/SKILL.md) |
